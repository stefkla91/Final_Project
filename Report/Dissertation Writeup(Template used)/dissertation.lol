...
\contentsline {lstlisting}{\numberline {A.1}Mark an cell as occupied}{65}
\contentsline {lstlisting}{\numberline {B.1}Moving forward}{67}
\contentsline {lstlisting}{\numberline {B.2}Turning an angle}{68}
\contentsline {lstlisting}{\numberline {B.3}Odometry struct}{70}
\contentsline {lstlisting}{\numberline {B.4}Initializing odometry struct}{70}
\contentsline {lstlisting}{\numberline {B.5}Updating odometry struct}{71}
\contentsline {lstlisting}{\numberline {B.6}Reference point struct}{73}
\contentsline {lstlisting}{\numberline {B.7}Function which checks if a reference point has been reached}{73}
\contentsline {lstlisting}{\numberline {B.8}Function to save a new reference point to the reference struct}{77}
